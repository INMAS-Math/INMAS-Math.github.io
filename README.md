...
Students were matched with internship
projects, which were coordinated through the efforts of
program coordinators based at the hubs.
...
statistics.
Educational and life impacts were felt as internships changed the life direction of
...
and end in March, with a possible internship taking place during the summer.
Training sessions are typically run outside normal school hours to minimize the
interference with regular activities such as classes and TA/RA duties. Professional training sessions
are typically between one and two hours long and are run remotely during the evenings.
Technical training sessions are delivered as workshops which run over the weekend,
starting at dinner time on Friday night and ending at mid-day on Sunday.
This allows non-local students to travel to the hub.

A calendar of activities is decided before the program is advertised. This is done so that students applying to
the program can evaluate their availability to participate in the program. A typical annual calendar of events
looks as follows:
