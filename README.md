...
and end in March. The training sessions are typically run outside normal school hours to minimize the
...
are provided as workshops which run over the weekend, starting on Friday night and ending at mid-day Sunday.

A calendar of activities is decided before the program is advertised. This is done so that students applying to
the program can evaluate their capabalities to participate in the program.

| Date | Activity| Dateescription |
| ---- | ----     | ---- |
...
| mid-October | Welcome session | Present program and rules |
| late October | Technical workshop #1 | Fundamentals of Python programming |
| early November | Professional training A | Session on resume preparation |
| mid November | Dealine to provide draft of resume | Last day to submit draft of resume |
| all November | Mentoring | One-on-one meetings to provide feedback on resume and career goals |
| late NOvember | Technical workshop #2 | Statistical Methods |
| early December | Deadline for final resume | Deadline to submit final resume |
| mid-January | Technical workshop #3 | Machine learning |
| early February | Professional training B | Inverview preparation |
| late February | Professioanl training C | Networking |
| late February | Technical workshop #4 | Projects and team work |
| March | Professional training D | Internship guidelines |
