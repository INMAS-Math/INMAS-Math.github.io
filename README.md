...
3. Sharing the progress of participating students as measured
...
The purpose of this document is to either provide a full road map or a mere inspiration to institutions
desiring to implement a similar or scaled-down version of a program addressing the needs identified by INMAS.
...
significantly during the past two decades. As a result, most PhD graduates need to pivot towards
...
some of which being offered and co-financed through INMAS. 
...
in the program and coordinated student applications to these internships.

The network structure enabled sharing of resources and best practices, and laid the
groundwork for potentially scaling up in the future.
The research impact of the project was substantial to the
organizations engaged in the network, for both companies and universities.
Interns participated in the creation of new tools that lead to greater efficiency,
productivity, and profitability for the companies.
...
in their confidence to influence and control their own career.
Engagement of students from under-represented groups increased
diversity in BIG and opened doors toward fulfilling careers for the students,
where they can subsequently serve as role models.
Furthermore, many employers discovered the talents offered by
...
The material for this workshop consisted mainly of Jupyter notebooks and is available here:
...
- Worksite location
- Contact information
- Type of internship (in-person, hybrid, or remote)
- Duration of internship in weeks
- US citizenship requirements (US citizen, US person, None)
- Skills required
- Desirable skills
